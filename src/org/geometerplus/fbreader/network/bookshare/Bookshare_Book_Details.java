...
public class Bookshare_Book_Details extends Activity{
	...
	Bookshare_Metadata_Bean metadata_bean;
	private InputStream inputStream;
	private BookshareWebservice bws = new BookshareWebservice();
	private final int DATA_FETCHED = 99;
	private ProgressDialog progessDialog;
	TextView bookshare_book_detail_title_text;
	TextView bookshare_book_detail_authors_text;
	TextView bookshare_book_detail_isbn_text;
	TextView bookshare_book_detail_language_text;
	TextView bookshare_book_detail_category_text;
	TextView bookshare_book_detail_publish_date_text;
	TextView bookshare_book_detail_publisher_text;
	TextView bookshare_book_detail_copyright_text;
	TextView bookshare_book_detail_bookshare_id_text;
	TextView bookshare_book_detail_synopsis_text;
	Button btn_download;
	boolean isDownloadable;
	private final int BOOKSHARE_BOOK_DETAILS_FINISHED = 1;
	File downloaded_zip_file;
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		System.out.println("****ID Search URI: "+uri);
					...
					btn_download.setOnClickListener(new OnClickListener(){
						public void onClick(View v){
							...
							if(btn_download.getText().toString().equalsIgnoreCase("Download")){
								...
								System.out.println("***** Finishing Bookshare_Book_Detail");
								finish();
							}
						}
					});
		...
		protected Void doInBackground(Void... params) {
			...
			try{
				...
				if (entity != null) {
					...
					String zip_file = external_storage_dir.getAbsolutePath() + "/Books/" + filename + ".zip";
					System.out.println("Download file = "+zip_file);
