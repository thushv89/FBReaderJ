...
/**
 * 
 * Class is used for reading the opf file which contains the 
 * meta info for the DAISY 3 book. The opf file is present at the 
 * same level as other files (xml, smil) of a DAISY 3 book.
...
class Daisy3MetaInfoReader extends ZLXMLReaderAdapter implements XMLNamespaces {
	...
	Daisy3MetaInfoReader(Book book) {
		myBook = book;
