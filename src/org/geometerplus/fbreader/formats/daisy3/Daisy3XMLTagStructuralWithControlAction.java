 ...
 *
 */
public class Daisy3XMLTagStructuralWithControlAction extends Daisy3XMLTagAction {
	 ...
	 */
	Daisy3XMLTagStructuralWithControlAction(byte control, String prelude, String postlude) {
		myControl = control;
		myPrelude = prelude;
		myPostlude = postlude;
	}
