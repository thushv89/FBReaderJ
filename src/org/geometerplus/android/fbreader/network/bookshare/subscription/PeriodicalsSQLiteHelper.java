...
public class PeriodicalsSQLiteHelper extends SQLiteOpenHelper {
	...
	public static final String TABLE_ALL_PERIODICALS = "all_downloaded_periodicals"; // table
																						// name
	...
	public static final String TABLE_SUBSCRIBED_PERIODICALS = "subscribed_periodicals"; // table
																						// name
	...
	private static final String CREATE_ALL_PERIODICALS_TABLE = "create table if not exists "
			...
			+ " int not null, "
			+ ALL_P_COLUMN_DOWNLOADED_DATE
			+ " text, "
			+ ALL_P_COLUMN_DOWNLOADED_TIME
			+ " text, "
			+ " primary key ("
			+ COLUMN_ID
			+ ", "
	...
	private static final String CREATE_SUBSCRIBED_PERIODICALS_TABLE = "create table if not exists "
			+ TABLE_SUBSCRIBED_PERIODICALS
			+ "("
			+ COLUMN_ID
			+ " text primary key, "
			+ COLUMN_TITLE
			+ " text not null,"
			+ SUBSCRIBED_COLUMN_LATEST_EDITION
			+ " text not null,"
	...
	public void onCreate(SQLiteDatabase db) {
		...
		Log.i("GoRead", getClass().getSimpleName() + " Created table with: "
				+ CREATE_ALL_PERIODICALS_TABLE);
		Log.i("GoRead", getClass().getSimpleName() + " Created table with: "
				+ CREATE_SUBSCRIBED_PERIODICALS_TABLE);
	}
